...
public class X12Parser implements Parser {
    ...
    private static final int POS_SIZE = 106;
    ...
    public EDI parse(File fileName) throws FormatException, IOException {
        ...
        var context = initContext(fileName);
    ...
    /**
     * private method to initialise the context
     *
     * @param scanner
     * @param context
     * @return
     */
    private Context initContext(File fileName) throws FormatException, IOException {
        // the spec assumes first line to be max 106 ascii or EBDIC characters
        var buffer = new byte[POS_SIZE];
        ...
        context.setSegmentSeparator(elements[16].charAt(1));
        context.setElementSeparator((char) buffer[POS_ELEMENT]);
        context.setCompositeElementSeparator(elements[16].charAt(0));
